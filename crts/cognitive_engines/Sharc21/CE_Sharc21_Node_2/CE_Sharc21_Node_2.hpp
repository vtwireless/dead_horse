#ifndef _CE_Sharc21_Node_2_
#define _CE_Sharc21_Node_2_

#include "cognitive_engine.hpp"


class CE_Sharc21_Node_2 : public CognitiveEngine {
...
private:
  ...
  float send_freq_time_s = 10.0;
  float timeout_time_s = 2.0;
  float listen_time_s = 0.2;
  
  // Frequencies
  const float rx_freqs[4] = {852e6, 851e6, 853e6, 852.5e6};
  const float tx_freqs[4] = {858e6, 859e6, 856e6, 858.5e6};
  
  const float default_rx_freq = 852e6;
  const float default_tx_freq = 858e6;
...
public:
  CE_Sharc21_Node_2(int argc, char **argv, ExtensibleCognitiveRadio *_ECR);
  ~CE_Sharc21_Node_2();
